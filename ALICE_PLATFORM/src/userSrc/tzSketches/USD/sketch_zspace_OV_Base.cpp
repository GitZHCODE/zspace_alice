...
static void shutdownOmniverse()
{
	...
	// The stage_in is a sophisticated object that needs to be destroyed properly.  
...
// Create a new connection for this model in Omniverse, returns the created stage_in URL
