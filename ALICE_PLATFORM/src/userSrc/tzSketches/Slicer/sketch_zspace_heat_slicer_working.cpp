...
void setup()
{
	...
	//fnSliceMesh.from("data/Slicer/guangduTest.obj", zOBJ);
	fnSliceMesh.from("data/Slicer/sliceMesh2.obj", zOBJ);

	// read mesh
	//myMeshParam.setFromFile("data/Parameterization/heatTest_ring_triangulated.obj", zOBJ);
	//myMeshParam.setFromFile("data/Slicer/guangduTest.obj", zOBJ);
	myMeshParam.setFromFile("data/Slicer/sliceMesh2.obj", zOBJ);
