...
bool toSTAD(string path, zObjMesh& o_Mesh, zObjMesh& o_Mesh_cap, zIntArray &supports, float &totalArea)
{
	...
	//zIntArray members_88_ValleyConnect_U;
	//zIntArray members_88_ValleyConnect_V;
	zIntArray members_100;
	...
	//for (int id : members_88_ValleyConnect_U)
	//{
	//	myfile << " " << id;
	//}
	//myfile << "TABLE ST 114.3X5.4CHS \n";

	for (int id : members_100)
	{
		myfile << " " << id;
	}
	myfile << " TABLE ST 114.3X5.4CHS \n";
