...
#include <zApp/include/zInterOp.h>
...
void setup()
{
	...
	std::string existingStage = "omniverse://nucleus.zaha-hadid.com/Projects/testCube_fCol_out_3108.usda";
	...
	omniCore.gLiveSessionInfo.Initialize(existingStage.c_str());

	omniCore.findOrCreateSession(omniCore.gStage, omniCore.gLiveSessionInfo);

	omniCore.gOmniChannel.SetChannelUrl(omniCore.gLiveSessionInfo.GetMessageChannelUrl().c_str());

	omniCore.gOmniChannel.LeaveChannel();
